...
type ClientInterface interface {
	...
	ListRestores(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) ListRestores(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListRestoresRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewListRestoresRequest generates requests for ListRestores
func NewListRestoresRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// ListRestoresWithResponse request
	ListRestoresWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*ListRestoresResponse, error)
...
// Status returns HTTPResponse.Status
func (r ListRestoresResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ListRestoresResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// ListRestoresWithResponse request returning *ListRestoresResponse
func (c *ClientWithResponses) ListRestoresWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*ListRestoresResponse, error) {
	rsp, err := c.ListRestores(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseListRestoresResponse(rsp)
}
...
// ParseListRestoresResponse parses an HTTP response from a ListRestoresWithResponse call
func ParseListRestoresResponse(rsp *http.Response) (*ListRestoresResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
