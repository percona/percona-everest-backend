...
type KubeClientConnector interface {
	...
	UpdateResource(ctx context.Context, name string, obj runtime.Object, into runtime.Object, opts *metav1.UpdateOptions) error
	// DeleteResource deletes a resource by its name.
	DeleteResource(ctx context.Context, name string, obj runtime.Object, opts *metav1.DeleteOptions) error
